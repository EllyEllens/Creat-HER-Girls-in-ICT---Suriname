  ...
  <main>
    ...
    <?php
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // SQL query for inserting data
          $sql = "INSERT INTO users (name, email, password, confirm) 
    ...
    <div class="inner-box">
      <div class="forms-wrap">
        <form action="Blockchain.php" autocomplete="off" class="sign-in-form" method="post">
          <div class="logo">
       ...
       <form action="Registration.php" autocomplete="off" class="sign-up-form" method="post">
          ...
          <div class="actual-form">
            ...
            <div class="input-wrap">
              <input type="password" minlength="4" class="input-field"
                name="confirm" autocomplete="off" required/>
